-- Fix admin_update_manual_valuation function to remove non-existent columns
CREATE OR REPLACE FUNCTION public.admin_update_manual_valuation(
  p_valuation_id uuid, 
...
BEGIN
  ...
  -- Update the manual valuation with valid fields only
