-- Optimize cleanup_cars_history_backlog() to avoid dashboard timeout
-- Limits to 10 batches per run (~100K records max)
...
BEGIN
  LOOP
    ...
    -- Exit if no more to delete OR we've hit max iterations
