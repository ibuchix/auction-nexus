-- Fix cleanup functions to use correct system_logs schema
-- The system_logs table has: log_type, message, details (not level, category, context)
...
BEGIN
  ...
  RETURN jsonb_build_object(
    ...
    'more_to_delete', EXISTS (SELECT 1 FROM cars_history WHERE created_at < cutoff_date LIMIT 1)
  );
END;
$$;
