-- Fix category mapping in admin_transfer_manual_valuation_to_cars_enhanced
-- Map 'additional' to 'additional_1' and handle numbered additional categories
...
BEGIN
  ...
  -- Transfer images from manual_file_uploads to car_file_uploads with category mapping
  ...
  LOOP
    -- Map category: 'additional' -> 'additional_1', 'additional_2', etc.
    IF v_image_record.category = 'additional' THEN
      ...
      END IF;
    ELSE
      -- Use the original category for all other cases
