-- Fix type conversion error in process_ended_auctions_securely()
-- Convert vehicle_data.images (text[]) to jsonb for vehicle_images column
...
BEGIN
  ...
  -- FIXED: Now handles both pre-update and post-update states
  ...
  LOOP
    ...
    -- FIXED: Convert text[] to jsonb for vehicle_images
...
-- Now manually process the 7 stuck auctions
