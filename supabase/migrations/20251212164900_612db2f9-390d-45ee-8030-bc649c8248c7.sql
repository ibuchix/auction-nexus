-- Update admin_get_manual_valuations to include condition question fields
...
BEGIN
  ...
  LOOP
    ...
    -- Add valuation with ALL fields from manual_valuations table, including condition questions
    v_valuations := v_valuations || jsonb_build_object(
      ...
      -- Vehicle Condition & Documentation (high-level)
      ...
      -- Detailed Condition Question Fields (15 booleans)
