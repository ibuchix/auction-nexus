-- Fix admin_end_auction_immediately to use correct enum value
-- Change 'auction_ended_manually' to 'auction_closed' which exists in audit_log_type enum
...
BEGIN
  ...
  -- Log the manual action (FIXED: use 'auction_closed' instead of 'auction_ended_manually')
