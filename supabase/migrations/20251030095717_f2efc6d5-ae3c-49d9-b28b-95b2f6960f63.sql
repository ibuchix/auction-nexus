-- Fix admin_get_manual_valuations to use correct table and return all fields
-- Previous migration referenced non-existent manual_valuation_images table
-- This corrects it to use manual_file_uploads and includes all missing fields
...
BEGIN
  ...
  LOOP
    ...
    -- Add valuation with ALL fields including previously missing finance & valuation fields
