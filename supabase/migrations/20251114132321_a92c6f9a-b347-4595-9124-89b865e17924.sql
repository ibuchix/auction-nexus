-- Create function to extend auction time with proper validation and audit logging
CREATE OR REPLACE FUNCTION public.extend_auction_time(
  p_car_id uuid,
...
-- Grant execute permission to authenticated users (admin check should be done at RLS/app level)
GRANT EXECUTE ON FUNCTION public.extend_auction_time TO authenticated;