-- Drop all existing versions of admin_transfer_manual_valuation_to_cars_enhanced
-- This ensures we only have the correct 2-parameter version with proper category mapping

DROP FUNCTION IF EXISTS admin_transfer_manual_valuation_to_cars_enhanced(uuid, numeric, jsonb);
DROP FUNCTION IF EXISTS admin_transfer_manual_valuation_to_cars_enhanced(uuid, numeric, text);
DROP FUNCTION IF EXISTS admin_transfer_manual_valuation_to_cars_enhanced(uuid, numeric);

-- Recreate the correct 2-parameter version with smart category mapping
